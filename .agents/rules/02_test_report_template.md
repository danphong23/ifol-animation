...
Tài liệu này định nghĩa **Cấu trúc Báo Cáo Chuẩn Bắt Buộc** cho mọi Test Case (từ TC01 đến tương lai) trong dự án `ifol-animation`. Mọi AI Agent và lập trình viên khi viết báo cáo kiểm thử đều phải tuân thủ nghiêm ngặt 6 phần này để đảm bảo người dùng có thể đọc hiểu trực quan, kiểm tra đúng/sai và nắm rõ toàn bộ thông số thời gian/hiệu năng.
