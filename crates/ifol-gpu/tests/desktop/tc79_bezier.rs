...
fn test_tc79_bezier() {
    pollster::block_on(async {
        ...
        println!("Bezier SDF Render Time: {:?}", t_elapsed);

        h.execute_and_record(&graph, &target_tex, "tc79_bezier", "Bezier Curve SDF Rendering", "GPU-accelerated exact Quadratic Bezier SDF rendering", "Render output");
    });
}
