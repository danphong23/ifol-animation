...
fn test_tc82_raymarching_3d() {
    pollster::block_on(async {
        ...
        println!("3D Raymarching Render Time: {:?}", t_elapsed);

        h.execute_and_record(&graph, &target_tex, "tc82_raymarching_3d", "3D Raymarching SDF Geometry", "Rendering 3D Torus with Phong lighting and SDF Raymarching on fullscreen quad", "Render output");
    });
}
