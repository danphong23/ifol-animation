            ...
            try:
                ...
                with open(metadata_path, 'w', encoding='utf-8') as f:
                    json.dump({
                        ...
                        'warm_diff_bytes': payload.get('warm_diff_bytes'),
                        'warm_diff_pixels': payload.get('warm_diff_pixels'),
                        'warm_max_channel_delta': payload.get('warm_max_channel_delta'),
                        'warm_pixel_diff_tolerance': payload.get('warm_pixel_diff_tolerance'),
                        ...
                        'numeric_validation': payload.get('numeric_validation'),
