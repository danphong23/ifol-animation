...
- **Thời gian Thực thi Cold Start:** 34.24ms
- **Thời gian Thực thi Warm/Cached:** 24.08ms
- **Ước tính Băng thông VRAM (Throughput):** 2.66 GB/s
- **Kết quả ảnh (Thực tế):**
...
- **Mô tả (Vision AI / Đánh giá):** GPU Compute phân phối 15,625 Workgroups (1,000,000 luồng GPU) tính toán tích phân chuyển động xoáy cho 1 triệu hạt mịn màng. Sau đó Render Pass tiến hành Instancing 1,000,000 Quads với chế độ Additive Blending tạo nên đám mây thiên hà hạt rực rỡ sắc màu phát sáng. Hệ thống đạt tốc độ mượt mà **24.08ms cho 1 triệu hạt**, băng thông VRAM ước tính **2.66 GB/s**.
