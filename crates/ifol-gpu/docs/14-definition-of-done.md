...
| Async readback/profiling | Đạt nền tảng | `ReadbackTicket`, `ExecutionReport` và timestamp capability snapshot đã có; query insertion, queue nhiều frame và profiling backend còn thiếu |
