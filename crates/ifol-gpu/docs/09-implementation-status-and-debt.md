...
- async readback ticket format-aware và execution report cấu trúc đã có; queue
  nhiều frame, worker scheduling, GPU timestamp và diagnostics đầy đủ vẫn còn thiếu;
